...
namespace Alice
{
    ...
    void AudioPlayerScript::PlaySfxPath(const std::string& path)
    {
        ...
        if (!audio)
        {
            ALICE_LOG_WARN("[AudioPlayer] Audio service not available.");
            return;
        }
        auto* resources = Resources();
        if (!resources)
        {
            ALICE_LOG_WARN("[AudioPlayer] ResourceManager not available.");
            return;
        }
    ...
    void AudioPlayerScript::PlaySfx1() { PlaySfxPath(Get_sfxPath1()); }
    void AudioPlayerScript::PlaySfx2() { PlaySfxPath(Get_sfxPath2()); }
    void AudioPlayerScript::PlaySfx3() { PlaySfxPath(Get_sfxPath3()); }
    void AudioPlayerScript::PlaySfx4() { PlaySfxPath(Get_sfxPath4()); }
    void AudioPlayerScript::PlaySfx5() { PlaySfxPath(Get_sfxPath5()); }
}
