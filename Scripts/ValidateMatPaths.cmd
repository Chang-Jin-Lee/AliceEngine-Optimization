...
set "BASE_DIR=%~dp0.."
set "TARGET_DIR=%BASE_DIR%\Assets\Materials"
if not "%~1"=="" set "TARGET_DIR=%~1"

echo [INFO] Starting .mat scan: %TARGET_DIR%
echo.
...
set "TEMP_PS1=%TEMP%\ValidateMatPaths_%RANDOM%_%RANDOM%.ps1"
...
$files = Get-ChildItem -Path $resolvedTarget -Filter *.mat -File -Recurse -ErrorAction SilentlyContinue
if ($null -eq $files -or $files.Count -eq 0) {
    Write-Host "[INFO] No .mat files found."
    exit 0
}
