...
namespace Alice
{
	void LinkComponentRegistry() {
        ALICE_LOG_INFO("[?±—ãÎµÜ??±ÎÄ? rttr Success");
    }
    ...
    RTTR_REGISTRATION
    {
        ...
        // XMFLOAT4X4¥¬ 4x4 «‡∑ƒ¿ª ≥™≈∏≥ª¥¬ ≈∏¿‘
        // ∑ª¥ı∏µ«“ ∂ß 4x4 «‡∑ƒ¿ª ∑ª¥ı∏µ«œ±‚ ¿ß«ÿ µÓ∑œ
        ...
        // SocketDef / SocketComponent µÓ∑œ (æ¿ ¿˙¿Â/∑ŒµÂ π◊ ¿ŒΩ∫∆Â≈Õ)
        ...
        // === CameraComponent µÓ∑œ ===
       // Transform¿∫ TransformComponentø°º≠ ¥„¥Á«œπ«∑Œ ø©±‚º± ¡¶ø‹
        ...
        // === PostProcessVolumeComponent µÓ∑œ ===
        ...
        // === Phy_RigidBodyComponent µÓ∑œ (physicsActorHandle¥¬ ≥ª∫ŒøÎ¿Ãπ«∑Œ µÓ∑œ«œ¡ˆ æ ¿Ω) ===
        ...
        // === Phy_ColliderComponent µÓ∑œ (physicsActorHandle¥¬ ≥ª∫ŒøÎ¿Ãπ«∑Œ µÓ∑œ«œ¡ˆ æ ¿Ω) ===
        ...
        // === Phy_MeshColliderComponent µÓ∑œ (physicsActorHandle¥¬ ≥ª∫ŒøÎ¿Ãπ«∑Œ µÓ∑œ«œ¡ˆ æ ¿Ω) ===
        ...
        // === Phy_TerrainHeightFieldComponent µÓ∑œ (physicsActorHandle¥¬ ≥ª∫ŒøÎ¿Ãπ«∑Œ µÓ∑œ«œ¡ˆ æ ¿Ω) ===
        ...
        // === TrailEffectComponent µÓ∑œ (trailSamples¥¬ ≥ª∫ŒøÎ¿Ãπ«∑Œ µÓ∑œ«œ¡ˆ æ ¿Ω) ===
	rttr::registration::class_<TrailEffectComponent>("TrailEffectComponent")
        ...
        // === CCTCapsuleClimbingMode enum µÓ∑œ ===
        ...
        // === Phy_CCTComponent µÓ∑œ (≥ª∫Œ «⁄µÈ∞˙ √‚∑¬ ∞™µÈ¿∫ ¡¶ø‹) ===
        ...
        // === Phy_JointComponent ?ÍπÖÏ§â (jointHandle ??Ä?????ñÏáÖ) ===
    ...
    // EditorComponentRegistry???åÎåÑÎ£??∞ÎìÉ ?ÍπÖÏ§â
    static void RegisterEditorComponentsOnce()
    {
        auto& r = EditorComponentRegistry::Get();

        // Transform?? ?Íæ©Îãî??∞„àÉ addable/removable ?å‚ë¶?ÉÊø°?
        ...
        r.Register<SkinnedMeshComponent>("Skinned Mesh", "Rendering",
            [](World& w, EntityId e) {
                w.AddComponent<SkinnedMeshComponent>(e, ""); // Êπ≤Í≥ï??™õ?
            });
