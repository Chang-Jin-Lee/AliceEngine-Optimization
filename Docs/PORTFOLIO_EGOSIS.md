...
![problem-lockon.png](problem-lockon.png)
...
![gif-rendering.png](gif-rendering.png)
...
- 실제 플레이·전투 화면 이미지와 GIF (`hero.png`, `gif-lockon.png`, `gif-rendering.png` 자리표시자 교체)
